...
/******/ 	__webpack_require__.p = "/wp-content/themes/sernova/dist/";
/******/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_modal__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_modal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__modules_modal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_menu__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_menu___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__modules_menu__);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (function () {
    ...
    localStorage.setItem = function (key, value) {
      if (key === 'LogLevel') {
        console.warn("Blocked storage of LogLevel: ".concat(value));
        return;
      }
      try {
        ...
        if (e.name === 'QuotaExceededError') {
          console.error("Quota exceeded for key \"".concat(key, "\""));
        }
      }
    };
  })();
...
document.addEventListener('DOMContentLoaded', function () {
  var backtopLink = document.querySelector('#backtop a');
  if (backtopLink) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var searchIcon = searchForm.querySelector('svg');
...
function findAndHighlightText(node, highlightWord) {
  if (node.nodeType === Node.TEXT_NODE) {
    var regex = new RegExp("(".concat(highlightWord, ")"), 'gi');
    ...
    node.childNodes.forEach(function (child) {
      return findAndHighlightText(child, highlightWord);
    });
  }
}
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
  var openButtons = document.querySelectorAll('.open-modal-button');
  ...
  openButtons.forEach(function (button) {
    button.addEventListener('click', function (event) {
      event.preventDefault();
      var modalId = button.getAttribute('href').substring(1);
...
/* WEBPACK VAR INJECTION */(function(jQuery) {jQuery(document).ready(function () {
  ...
  var isMobile = {
    ...
    any: function any() {
      return isMobile.Android() || isMobile.Opera() || isMobile.BlackBerry() || isMobile.iOS() || isMobile.Windows();
    }
  };
  if (isMobile.any()) {
    ...
    if (menuArrows.length > 0) {
      var _loop = function _loop() {
        var thisArrow = menuArrows[i];
        var subMenu = menuArrows[i].nextElementSibling;
        var parentMenuItem = menuArrows[i].parentElement;
        ...
        thisArrow.addEventListener("click", function () {
          ...
          var maxMenuHeight = windowHeight - thisArrow.getBoundingClientRect().bottom;
    ...
    menuItems.forEach(function (menuItem) {
      var thisArrow = menuItem.querySelector('.nav-desc');
  ...
  if (iconMenu) {
    ...
    var navLinks = menuBody.querySelectorAll('a');
    for (var _i2 = 0; _i2 < navLinks.length; _i2++) {
      navLinks[_i2].addEventListener('click', function () {
